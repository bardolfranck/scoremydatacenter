...
| **ES** | factory `l3_ied` | ~6/12 | energy-charts | WISE universal (patchy inland) | EEA | Corine | L3 EEA IED Seveso, L1 Eurostat (raw) | **WATER angle**: Madrid/Barcelona on Aqueduct *Extremely High* (W1 zre_or_crisis). DCs scraped from PeeringDB + Meta Talavera/AWS Aragón (geocoded) |
| **IT** | factory `l3_ied` | ~6/12 | energy-charts | WISE universal (patchy inland) | EEA | Corine | L3 EEA IED Seveso, L1 Eurostat (raw) | **WATER divide**: Milan hub water-abundant (no_stress), Rome/South *Extremely High*. Income tracks it too (Lombardy 27500 vs Sicily 17300). DCs scraped PeeringDB |
