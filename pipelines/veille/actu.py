...
{{
 ...
 "entities": {{"operator": "<si identifiable, sinon null>", "location": "<commune/région FR si citée, sinon null>",
             "act": "<l'ACTE administratif/de projet décrit, s'il y en a un — sinon null. AGRÉMENTS (feu vert) : 'permis' (permis de construire accordé), 'autorisation' (autorisation environnementale/préfectorale), 'vote_favorable' (délibération/vote favorable d'un conseil), 'inauguration' (mise en service). CONTESTATION : 'opposition' (opposition/mobilisation de riverains, collectif), 'recours' (recours administratif/juridictionnel), 'enquete_publique' (enquête publique ouverte/en cours/conclusions), 'moratoire' (moratoire voté ou proposé), 'referendum' (référendum/consultation locale), 'petition' (pétition), 'suspension' (suspension judiciaire d'un permis/projet), 'abandon' (abandon/retrait du projet ou du permis). Autres : 'chantier' (début des travaux), 'investissement' (annonce d'investissement chiffré), 'annonce' (simple annonce). Choisis l'acte LE PLUS SPÉCIFIQUE (une suspension judiciaire = 'suspension', pas 'opposition'). REMPLIS ce champ dès que l'article décrit un tel acte — c'est un signal-clé ; null seulement si aucun acte concret n'est mentionné.>"}},
