...
export const RICH_FR: Record<string, RichBlock> = {
    ...
    points: [
      {
        icon: "energy",
        lead: "L'électricité.",
        body: "Les grands projets récents demandent 100 à 200 MW, l'équivalent de la consommation électrique de villes comme Le Mans ou Saint-Étienne (RTE, 2026). Cette puissance passe par le réseau local : postes électriques, lignes, travaux.",
      },
      {
        icon: "water",
        lead: "L'eau.",
        body: "Certaines techniques de refroidissement consomment très peu d'eau, d'autres beaucoup : les data centers d'Amazon ont prélevé environ 9,5 milliards de litres dans le monde en 2025, premier chiffre annuel publié par l'entreprise (Data Center Dynamics, 2026). Le sujet est pris au sérieux par la loi : depuis mai 2026, un permis de construire peut être refusé en raison de « tensions structurelles sur la ressource en eau » (loi n° 2026-403 du 26 mai 2026, art. 35).",
      },
      {
        icon: "noise",
        lead: "Le bruit.",
      ...
      },
      {
        ...
        body: "Un méga-projet peut occuper des dizaines d'hectares — environ 90 pour le Campus IA de Fouju (concertation publique Campus IA). Pour une emprise comparable, une plateforme logistique emploie typiquement 300 à 400 personnes, un data center autour de 15 à 20 (AFP / Connaissance des énergies, 2026).",
      },
      {
        icon: "tax",
        lead: "La fiscalité.",
        body: "Le site paie des impôts locaux (taxe foncière, cotisation foncière des entreprises, notamment), répartis entre commune, intercommunalité et autres collectivités — avec des exonérations possibles les premières années (service-public.fr). D'où la question à poser : quelles recettes, pour qui, à partir de quand ?",
      },
    ],
    takeaway:
  ...
  "bon-projet": {
    ...
    points: [
      ...
      },
      {
        ...
        body: "La loi impose d'étudier la valorisation de la chaleur produite (code de l'énergie, art. L.236-2, issu de la loi du 30 avril 2025). La différence se joue entre une étude de principe et un contrat signé avec un réseau de chaleur, une piscine, des serres. Où vérifier : demander si un contrat existe, et avec qui.",
      },
      {
      ...
      },
      {
        ...
        body: "Consommations d'électricité et d'eau, efficacité mesurée — la loi prévoit d'ailleurs une déclaration de performance pour les centres de données (code de l'énergie, art. L.236-1). Où vérifier : ce que le dossier promet de rendre public, et à quel rythme.",
      },
      {
  ...
  droits: {
    intro:
      "Un data center n'obtient pas une autorisation, mais plusieurs : un permis de construire, et le plus souvent une autorisation environnementale — le régime ICPE, qui encadre les installations industrielles (Gossement Avocats, 2026). Chacune a son calendrier, et chacune ouvre des droits au public.",
    points: [
      {
        lead: "Avant le dépôt : la concertation.",
        body: "Une concertation préalable, parfois avec un garant nommé par la CNDP (la Commission nationale du débat public), peut se tenir en amont. Attention : depuis un décret du 3 mars 2026, les data centers ne font plus partie des projets à saisine obligatoire de la CNDP (Actu-Environnement, 2026) — la tenue d'une concertation dépend donc du porteur du projet ou de l'État. Si elle a lieu, c'est le moment où le projet peut encore changer le plus.",
      },
      {
        lead: "Pendant l'instruction : l'enquête publique.",
        body: "Pour les projets soumis à évaluation environnementale, elle dure au minimum 30 jours (code de l'environnement, art. L.123-9). Chacun — habitant ou non de la commune — peut déposer des observations écrites, en mairie ou en ligne. Elles sont versées au dossier et le commissaire enquêteur y répond dans son rapport.",
      },
      {
        lead: "Cas particulier depuis mai 2026.",
        body: "Un data center peut être qualifié par décret de « projet d'intérêt national majeur » : le permis est alors instruit par le préfet, et non par le maire. Même dans ce cas, le permis peut être refusé en raison de « tensions structurelles sur la ressource en eau » (loi n° 2026-403 du 26 mai 2026, art. 35).",
      },
      {
...
export const RICH_EN: Record<string, RichBlock> = {
    ...
    points: [
      {
        icon: "energy",
        lead: "Electricity.",
        body: "Recent large projects request 100 to 200 MW, the equivalent of the electricity consumption of cities like Le Mans or Saint-Étienne (RTE, 2026). That power flows through the local grid: substations, lines, works.",
      },
      {
        icon: "water",
        lead: "Water.",
        body: "Some cooling techniques use very little water, others a lot: Amazon's data centers withdrew about 9.5 billion liters worldwide in 2025, the first annual figure the company has published (Data Center Dynamics, 2026). The law takes the matter seriously: since May 2026, a building permit can be refused in France over “structural tensions on the water resource” (law no. 2026-403 of May 26, 2026, art. 35).",
      },
      {
        icon: "noise",
        lead: "Noise.",
      ...
      },
      {
        icon: "land",
        lead: "Land and jobs.",
        body: "A mega-project can occupy dozens of hectares — about 90 for the Fouju AI Campus (Campus IA public consultation). For a comparable footprint, a logistics platform typically employs 300 to 400 people, a data center around 15 to 20 (AFP / Connaissance des énergies, 2026).",
      },
      {
        icon: "tax",
        lead: "Tax revenue.",
        body: "The site pays local taxes (property tax and the local business levy, among others), split between the municipality, the inter-municipal body and other authorities — with possible exemptions in the first years (service-public.fr). Hence the question to ask: what revenue, for whom, starting when?",
      },
    ],
    takeaway:
  ...
  "good-project": {
    ...
    points: [
      ...
      },
      {
        ...
        body: "French law requires studying the reuse of the heat produced (energy code, art. L.236-2, from the law of April 30, 2025). The difference lies between a paper study and a signed contract with a heat network, a swimming pool, greenhouses. Where to check: ask whether a contract exists, and with whom.",
      },
      {
      ...
      },
      {
        ...
        body: "Electricity and water consumption, measured efficiency — the law in fact provides for a performance declaration for data centers (energy code, art. L.236-1). Where to check: what the filing promises to make public, and how often.",
      },
      {
  ...
  rights: {
    intro:
      "A data center does not get one authorization but several: a building permit and, most often, an environmental authorization — the French ICPE regime, which governs industrial installations (Gossement Avocats, 2026). Each has its calendar, and each opens rights to the public.",
    points: [
      {
        lead: "Before filing: the public consultation.",
        body: "A prior consultation, sometimes with a guarantor appointed by the CNDP (France's national commission for public debate), may be held upstream. Note: since a decree of March 3, 2026, data centers are no longer among the projects requiring mandatory CNDP referral (Actu-Environnement, 2026) — whether a consultation happens now depends on the developer or the State. When it does happen, it is the moment the project can still change the most.",
      },
      {
        lead: "During review: the public inquiry.",
        body: "For projects subject to environmental assessment it lasts at least 30 days (environment code, art. L.123-9). Anyone — resident of the municipality or not — can file written observations, at the town hall or online. They join the file and the inquiry commissioner responds to them in the report.",
      },
      {
        lead: "A special case since May 2026.",
        body: "A data center can be designated by decree a “project of major national interest”: the permit is then processed by the préfet, not the mayor. Even then, the permit can be refused over “structural tensions on the water resource” (law no. 2026-403 of May 26, 2026, art. 35).",
      },
      {
